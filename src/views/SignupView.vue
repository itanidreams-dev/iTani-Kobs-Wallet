...
async function validateSignup() {
  ...
  const account = {
    address,
    encryptedPrivateKey: walletStore.encryptPrivateKey(
...
<template>
  <div class="auth-form">
    <h2>Inscription</h2>
    <p class="subtitle">Crée un nouveau compte pour démarrer.</p>
    ...
    <div class="actions">
      <button class="primary" @click="validateSignup">Valider</button>
      <RouterLink class="link" to="/login">Déjà un compte ?</RouterLink>
    </div>
  </div>
</template>
